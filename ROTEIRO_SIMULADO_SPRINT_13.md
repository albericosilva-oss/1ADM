...
### 🟡 A Limpeza do Terreno (Higienização de Dados)
...
5. **Higienização Vital:** 
   ...
   - A Armadilha do Ponto: O valor `50.00` não converte para moeda no Excel em PT-BR, ele vira texto. alterar o ponto para vírgula manualmente se der erro. Apagar os textos como "R$ 50,00" e "cinquenta", digitar o número puro (`50`) e só então clicar em **Moeda**.
...
### 🟢 Automação Matemática (O Coração da Planilha)
...
### 🏆 O "Relatório Tá na Mesa" (Fechamento)
1.  precisam subir a planilha limpa, formatada e com os gráficos no Google Drive  e compartilhar o link para o classroom 
